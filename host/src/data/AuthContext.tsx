...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  // action, and the client's cached sign-in could be stale), then has the
  // deleteAccount Cloud Function -- running with the Admin SDK, so it can
  // cascade through Firestore/Storage in ways client-side rules never allow
  // -- wipe every event, support thread, and file this account owns before
  // deleting the Auth user itself.
